...
class AuthProcessor {
    ...
    // Конструктор класу, в якому ініціалізується поле для збереження наступного обробника в ланцюгу.
    constructor() {
    ...
    // Якщо так, передає запит на перевірку аутентифікації наступному обробнику, та повертаємо результат.
